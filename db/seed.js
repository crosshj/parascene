...
const seedData = {
	...
	policy_knobs: [
		...
		{ key: "related.lineage_weight", value: "100", description: "Score for lineage (ancestor/child)." },
		{ key: "related.lineage_min_slots", value: "2", description: "Minimum lineage results in top N." },
