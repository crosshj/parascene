/**
 * Chat Rollup bundle — feed card HTML helpers (`src/shared/`). Spotlight partition helpers live in
 * `chatFeedMobilePartition.js` (also re-exported here). Align `public/shared/feedCardBuild.js` when changing partition behavior.
 */
