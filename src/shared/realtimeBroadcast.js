/**
 * Chat Rollup bundle copy — canonical: `public/shared/realtimeBroadcast.js`.
 * Wired via `CHAT_BUNDLE_SHARED_OVERRIDES['/shared/realtimeBroadcast.js']` in `src/rollup.config.mjs`.
 */
