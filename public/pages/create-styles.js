/**
 * Create page style presets keyed by style key. Keys match data-key on .create-style-card in create.html.
...
/**
 * Get modifiers string for a style key.
 * @param {string} key - data-key of the style (e.g. 'cinematic', 'none')
 * @returns {string}
 */
export function getModifiersForStyle(key) {
