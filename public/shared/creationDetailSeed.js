...
const [creationGroupMediaMod, audioCoverWaveformMod, creationGpuWaitMod] = await Promise.all([
...
const { creationGpuWaitMarkup, isCreationGpuInFlight } = creationGpuWaitMod;
