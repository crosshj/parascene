/**
 * Blog URL campaign segments — shared by browser (feed, create) and re-exported from lib/ for Node.
 * Keep this file the single source of truth; lib/blog/campaignPath.js re-exports it for the API.
 */
