...
const { challengeEnteredBadgeHtml } = await import(`./creationBadges.js${_qs}`);
...
export function isCreationPublished(item) {
	...
	// Feed/explore creation rows without an explicit flag are published creations.
 ...
 * @param {{ title?: string|null, published?: boolean|number|null }} item
